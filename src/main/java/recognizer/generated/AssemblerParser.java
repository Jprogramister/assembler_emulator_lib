...
public class AssemblerParser extends Parser {
	...
	public static class CommandContext extends ParserRuleContext {
		...
		public TerminalNode DELIM() { return getToken(AssemblerParser.DELIM, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof AssemblerVisitor ) return ((AssemblerVisitor<? extends T>)visitor).visitCommand(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ProcedureReturnContext extends InstructionContext {
		...
		public ProcedureReturnContext(InstructionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof AssemblerVisitor ) return ((AssemblerVisitor<? extends T>)visitor).visitProcedureReturn(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ResetInterruptionFlagContext extends InstructionContext {
		public TerminalNode STI() { return getToken(AssemblerParser.STI, 0); }
		public ResetInterruptionFlagContext(InstructionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof AssemblerVisitor ) return ((AssemblerVisitor<? extends T>)visitor).visitResetInterruptionFlag(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class UnaryOperationLabelJumpContext extends UnaryOperationContext {
		...
		public TerminalNode ID() { return getToken(AssemblerParser.ID, 0); }
		public UnaryOperationLabelJumpContext(UnaryOperationContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AssemblerListener ) ((AssemblerListener)listener).enterUnaryOperationLabelJump(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof AssemblerVisitor ) return ((AssemblerVisitor<? extends T>)visitor).visitUnaryOperationLabelJump(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class UnaryOperationProcedureCallContext extends UnaryOperationContext {
		...
		public TerminalNode ID() { return getToken(AssemblerParser.ID, 0); }
		public UnaryOperationProcedureCallContext(UnaryOperationContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AssemblerListener ) ((AssemblerListener)listener).enterUnaryOperationProcedureCall(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AssemblerListener ) ((AssemblerListener)listener).exitUnaryOperationProcedureCall(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof AssemblerVisitor ) return ((AssemblerVisitor<? extends T>)visitor).visitUnaryOperationProcedureCall(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class BinaryOperationRegisterConstContext extends BinaryOperationContext {
		...
		public TerminalNode NUMBER() { return getToken(AssemblerParser.NUMBER, 0); }
		public BinaryOperationRegisterConstContext(BinaryOperationContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AssemblerListener ) ((AssemblerListener)listener).enterBinaryOperationRegisterConst(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AssemblerListener ) ((AssemblerListener)listener).exitBinaryOperationRegisterConst(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof AssemblerVisitor ) return ((AssemblerVisitor<? extends T>)visitor).visitBinaryOperationRegisterConst(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BinaryOperationRegistersContext extends BinaryOperationContext {
		...
		public TerminalNode COMMA() { return getToken(AssemblerParser.COMMA, 0); }
		public BinaryOperationRegistersContext(BinaryOperationContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AssemblerListener ) ((AssemblerListener)listener).enterBinaryOperationRegisters(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AssemblerListener ) ((AssemblerListener)listener).exitBinaryOperationRegisters(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof AssemblerVisitor ) return ((AssemblerVisitor<? extends T>)visitor).visitBinaryOperationRegisters(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\b\5\2 !\7\20\2\2!&\3\2\2\2\"#\5\6\4\2#$\7\20\2\2$&\3\2\2\2%\31\3\2\2"+
